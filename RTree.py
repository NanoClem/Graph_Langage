...
class RTree:
    """
        Cette classe modelise un arbre enracine
    """
...
n3=RTree('m')
n2=RTree('a')
# Construction des noeuds pères
n1=RTree('2',[n4,n5,n6])
n0=RTree('z',[n1,n2,n3])    # racine
...
print("Parcours en profondeur :", n0.display_Rdeph())
print("Parcours en largeur :", n0.display_width())